...
image::cloud.jpg[align=center, width=70%, link="https://www.flickr.com/photos/inkdroid/15898721715/", label="Fluffy white clouds in a blue sky."]
...
image::devtools.png[align=center, width=65%, label="Developer Tools View in a Web Browser"]
...
image::apis.png[align=center, width=70%, label="Icons of various Web services that offer APIs"]
...
image::requests.png[align=center, width=35%, link="http://docs.python-requests.org/", label="Homepage of the Python requests library"]
