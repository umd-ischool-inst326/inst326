...
Download [this CSV dataset](data/MD_COVID19_TotalVaccinationsCountyFirstandSecondDose.csv) for the __The cumulative number of COVID-19 vaccinations within a single Maryland__  dataset that was originally published by the Maryland Department of Health at https://coronavirus.maryland.gov/datasets/md-covid19-totalvaccinationscountyfirstandseconddose (but it has since been removed).
