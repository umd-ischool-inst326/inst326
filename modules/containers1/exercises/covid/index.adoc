...
CSV file] for the __The cumulative number of COVID-19 vaccinations within a single Maryland__  dataset that was originally published by the Maryland Department of Health at https://coronavirus.maryland.gov/datasets/md-covid19-totalvaccinationscountyfirstandseconddose but has since been removed.
